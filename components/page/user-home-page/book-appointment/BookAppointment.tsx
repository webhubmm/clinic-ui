          ...
          <Box flex="1">
            ...
            >
              <Box className="space-y-8">
                <Text color="neat.primary">What we do</Text>
                <Box color="neat.secondary" width={{ sm: "100%", md: "80%" }}>
                  <Heading marginY="20px">Provide genuine dental care</Heading>
                </Box>
                <Box
                  display="flex"
                  flexDir={{ sm: "column-reverse", md: "row", lg: "row" }}
                  gap="3"
                >
                  <Stack spacing={20} maxW={{ lg: "220px" }}>
                    <Text color="slate" lineHeight={2} fontWeight={600}>
