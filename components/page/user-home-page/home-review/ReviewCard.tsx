...
interface reviewProps {
  id: number;
  title: string;
  imagesH: StaticImageData;
  desc: string;
  img: StaticImageData;
  name: string;
  city: string;
}
export default function ReviewCard({ item }: { item: reviewProps }) {
  return (
    <Box position="relative" width={{ sm: "100%", md: "350px", lg: "400px" }}>
      ...
      <Card
        paddingX="2rem"
        paddingY={{ sm: "1rem", md: "1rem", lg: "3rem" }}
        maxW={{ sm: "85%", md: "300px", lg: "330px" }}
        borderRadius="15px"
        position="absolute"
        bottom={{ sm: "-40", md: "-40", lg: "-40" }}
        left="8%"
      >
        <Box
          display="flex"
        ...
        >
          ...
          <Text color="slate">
            “I had a dental emergency called here, and they were able to see me
            right away”.
          </Text>
