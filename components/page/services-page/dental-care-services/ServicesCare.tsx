...
export default function ServicesCare() {
  return (
    <Box bg='neat.pearlwhite' paddingTop='8rem' paddingBottom='40rem'>
        <Container maxW='container.xl'>
          <Box position='relative'>
          <Box display='flex'  justifyContent='space-around' alignItems='start' gap='5'>
            <Box>
                <Image src={serviceCareImg} alt="service img" width={600} height={500}/>
            </Box> 
            <Box display='grid' gap='5' maxW='lg' mt='10'>
             ...
             <Wrap spacing='30px' position='absolute' top='57%' left='15%'>
              {
