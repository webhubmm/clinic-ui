...
export default function HealthCard({ list }: { list: ListProps }) {
  return (
    <Box width={{ sm: "100%", md: "100%", lg: "100%" }}>
      <Card
        padding={{ sm: "2rem", lg: "1.5rem" }}
        borderRadius="12px"
        maxW="100%"
      >
          ...
          <Box maxW="md" display="grid" gap="8">
            ...
            <Stack spacing={2}>
              <Flex gap="5">
                ...
                <Text as="span">{list?.listOne}</Text>
              </Flex>
              <Flex gap="5">
                <Box color="neat.primary">
                  <FaCircleCheck size={20} />
                </Box>
                <Text as="span">{list?.listTwo}</Text>
              </Flex>
              <Flex gap="5">
                <Box color="neat.primary">
                  <FaCircleCheck size={20} />
                </Box>
                <Text as="span">{list?.listThree}</Text>
              </Flex>
            </Stack>
          </Box>
        </Box>
