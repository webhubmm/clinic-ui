...
export default function DoctorCard({ item }: { item: DoctorProps }) {
  return (
    <Box marginTop="3rem" width={{ md: "350px", lg: "300px" }}>
      <Box
        position="relative"
        marginBottom="3rem"
        width={{ md: "350px", lg: "100%" }}
      >
        <Image
          src={item?.img}
          alt={`${item?.name} ${item.skill}`}
          width="0"
          height="0"
          sizes="100vw"
