    ...
    <Box bg='neat.pearlwhite' paddingY='6rem'>
        <ContainerBox>
         <Box display='grid'  gap='5'  >
            ...
            <Heading  color='neat.secondary' fontSize={{sm:'2.5rem',lg:'3.5rem'}}>
          ...
          <Card padding='2rem'>
            <Box display={{sm:'grid',lg:'flex'}} gridTemplateColumns={{sm:'repeat(1,1fr)',md:'repeat(2,1fr)'}}  justifyContent='space-between' gap='8'>
                 {
                    cardList?.map((item) =>(
